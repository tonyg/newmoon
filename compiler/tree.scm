...
(define make-lambda (make-node-constructor 'lambda '(all-arginfos all-varargs all-bodies)))
...
(define make-jvm-assemble (make-node-constructor 'jvm-assemble '(formals actuals code)))
